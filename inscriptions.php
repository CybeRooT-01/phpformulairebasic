...
if (!empty($_POST)) {
    ...
    if ($_POST["email"] == isset($user["email"])) {
        $_SESSION["error"][] = "cet utilisateur existe deja";
    }
    if (
        ...
        <section class="section-left">
            <div class="bouton">
                ...
                <p class=" text-para">Nous sommes heureux de vous revoir geek<br>Vous avez deja un compte
                    ?<br>Connectez-vous</p>
            </div><a href="connexion.php" target="_blank"><button class="btn-sing">Connexion</button></a>
        </section>
        <section class="section-right">
            <div class="account">
                <h4>Créér un compte</h4>
                <div class="reseaux-sociaux">
                    <p><span><a><img src="img/google.png " draggable="false"></a></span><span><a><img
                                    src="img/facebook.png" draggable="false"></a></span><span><a><img
                                    src=" img/LinkedIn.png" draggable="false"></a></span></p>
                </div>
            </div>
            <form method="post">
                <div class="input-group"><span><img src="img/person.png" draggable="false"></span><input type="text"
                        name="name" placeholder="Nom" required></div>
                <div class="input-group"><span><img src="img/Email.png" draggable="false"></span><input type="text"
                        name="email" placeholder="E-mail" autocomplete="off" required></div>
                <div class="input-group"><span><img src="img/passwd.png" draggable="false"></span><input type="password"
                        name="pass" placeholder="Mot de passe" required></div>
                <div><button type="submit" class="btn-connexion">S'inscrire</button>
                </div>
                <?php 
